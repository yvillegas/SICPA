...
class DetalleIngresoExternoController extends Controller {
	...
	*/
	...
	public function getIndex(Request $request)
	{
		...
		if($ieexterno->comp_moneda=='SOLES')
			$moneda='S/. ';
		else
			$moneda='$. ';

		return view('detalleingresoexterno.mostrar',['detalleies'=> $detalleies,'ieexterno'=> $ieexterno,'moneda'=> $moneda]);
	}
	...
	public function getCrear(Request $request)
	{
		$this->validate($request,['ie_id'=>'required']);
		$ie_id=$request->get('ie_id');
		return view('detalleingresoexterno.crear',['ie_id'=> $ie_id]);
	}
	...
	public function postCrear(CrearDetalleIERequest $request)
	{
		...
		return redirect("/validado/detalleingresoexterno?ie_id={$ie_id}")->with('creado','Detalle Comprobante creado');
	...
	public function getEditar(Request $request)
	{
		...
		return view('detalleingresoexterno.editar',['detalleie'=>$detalleie]);
	...
	public function postEditar(EditarDetalleIERequest $request)
	{
		...
		return redirect("/validado/detalleingresoexterno?ie_id={$ie_id}")->with('actualizado','Detalle Comprobante actualizado');
	}
	...
	public function getEliminar(Request $request)
	{
		...
		return redirect('/validado/detalleingresoexterno')->with('eliminado','Detalle Comprobante eliminado');
	}
