...
class DetalleSalidaController extends Controller {
	...
	*/
	...
	public function getIndex(Request $request)
	{
		...
		return view('detallesalida.mostrar',['detallecomprobantes'=> $detallecomprobantes,'comprobante'=> $comprobante,'moneda'=> $moneda]);
	}
	...
	public function getCrear(Request $request)
	{
		...
		return view('detallesalida.crear',['productos'=> $productos,'unidadmedidas'=> $unidadmedidas,'comp_id'=> $comp_id]);
	}
	...
	public function postCrear(CrearDetalleComprobanteRequest $request)
	{
		...
		{
			return redirect("/validado/detallesalida?comp_id={$comp_id}")->with('error','ESTE PRODUCTO SI ESTA EXONERADO DE IGV');
		}
		...
		{
			return redirect("/validado/detallesalida?comp_id={$comp_id}")->with('error','ESTE PRODUCTO NO ESTA EXONERADO DE IGV');
		}
	...
	public function getEditar(Request $request)
	{
		...
		return view('detallesalida.editar',['detallecomprobante'=>$detallecomprobante,'productos'=>$productos,'unidadmedidas'=>$unidadmedidas]);
	...
	public function getImprimir(Request $request)
	{
		...
		if($comprobante->tipocomprobante->tcomp_desc=='Boleta')
			return view('detallesalida.imprimirboleta',['detallecomprobantes'=> $detallecomprobantes,'comprobante'=> $comprobante,'moneda'=> $moneda]);
		else
			return view('detallesalida.imprimirfactura',['detallecomprobantes'=> $detallecomprobantes,'comprobante'=> $comprobante,'moneda'=> $moneda]);
	}
	...
	public function getGenerartxt(Request $request)
	{
		...
		return view('detallesalida.txt',['detallecomprobantes'=> $detallecomprobantes,'comprobante'=> $comprobante]);
	}
