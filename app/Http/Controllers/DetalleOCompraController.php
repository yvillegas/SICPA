...
class DetalleOCompraController extends Controller {
	...
	*/
	...
	public function getIndex(Request $request)
	{
		...
		return view('detalleocompra.mostrar',['detalleordencvs'=> $detalleordencvs,'ordencv'=> $ordencv,'moneda'=> $moneda]);
	}
	...
	public function getCrear(Request $request)
	{
		...
		return view('detalleocompra.crear',['productos'=> $productos,'unidadmedidas'=> $unidadmedidas,'ocv_id'=> $ocv_id]);
	}
	...
	public function postCrear(CrearDetalleOrdenCVRequest $request)
	{
		...
		return redirect("/validado/detalleocompra?ocv_id={$ocv_id}")->with('creado','Detalle Orden de Compra creado');
	}
	...
	public function getEditar(Request $request)
	{
		...
		return view('detalleocompra.editar',['detallecomprobante'=>$detallecomprobante,'productos'=>$productos,'unidadmedidas'=>$unidadmedidas]);
	...
	public function postEditar(EditarDetalleOrdenCVRequest $request)
	{
		...
		return redirect("/validado/detalleocompra?ocv_id={$ocv_id}")->with('actualizado','Detalle Orden Compra actualizado');
	}
	...
	public function getEliminar(Request $request)
	{
		...
		return redirect('/validado/detalleocompra')->with('eliminado','Detalle Orden de Compra eliminado');
	}
