		...
		<div class="col-md-8 col-md-offset-2">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<form class="form-horizontal" role="form" method="POST" action="/validado/detalleingreso/crear">
						<input type="hidden" name="_token" value="{{ csrf_token() }}">
						<input type="hidden" class="form-control text-uppercase" name="comp_id" value='{{$comp_id}}'>
						...
						<div class="form-group">
							<div class="col-md-6 col-md-offset-4">
								...
								<a href="/validado/detalleingreso?comp_id={{$comp_id}}" class="btn btn-danger" role="button">Cancelar</a>
							</div>
						</div>
					</form>
				</div>
