		...
		<div class="col-md-8 col-md-offset-2">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<form class="form-horizontal" role="form" method="POST" action="/validado/detallenpedido/crear">
						<input type="hidden" name="_token" value="{{ csrf_token() }}">
						<input type="hidden" class="form-control text-uppercase" name="ocv_id" value='{{$ocv_id}}'>
						<div class="form-group">
							<label class="col-md-4 control-label">Cantidad</label>
							<div class="col-md-6">
								<input type="text" class="form-control text-uppercase" name="docv_cant">
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-md-6">
								<input type="text" class="form-control text-uppercase" name="docv_prec">
							</div>
						</div>
						<div class="form-group">
							<div class="col-md-6 col-md-offset-4">
								...
								<a href="/validado/detallenpedido?ocv_id={{$ocv_id}}" class="btn btn-danger" role="button">Cancelar</a>
							</div>
						</div>
					</form>
				</div>
