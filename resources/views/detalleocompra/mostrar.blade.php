...
<div class="container-fluid">
	...
	<div class="col-md-8 col-md-offset-2">
		<div class="panel panel-default">
			<div class="panel-body">
				<a href="/validado/detalleocompra/crear?ocv_id={{$ordencv->ocv_id}}" class="btn btn-success" role="button">+</a>
				<br/><br/>
				...
				@if(sizeof($detalleordencvs)>0)
					...
					@foreach ($detalleordencvs as $detalleordencv)
						<tr>
							...
							<td>
							<a href="/validado/detalleocompra/eliminar?docv_id={{$detalleordencv->docv_id}}" onclick="return confirm('Esta seguro que desea eliminar?')" class="btn btn-danger">Eliminar</a>
						</tr>
					@endforeach
		...
		<a href="/validado/ocompra" class="btn btn-danger" role="button">Regresar</a>
	</div>
</div>
@endsection
