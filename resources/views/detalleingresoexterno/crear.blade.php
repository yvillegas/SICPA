		...
		<div class="col-md-8 col-md-offset-2">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<form class="form-horizontal" role="form" method="POST" action="/validado/detalleingresoexterno/crear">
						...
						<div class="form-group">
							<div class="col-md-6 col-md-offset-4">
								...
								<a href="/validado/detalleingresoexterno?ie_id={{$ie_id}}" class="btn btn-danger" role="button">Cancelar</a>
							</div>
						</div>
					</form>
				</div>
