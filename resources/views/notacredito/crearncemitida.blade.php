			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<form class="form-horizontal" role="form" method="POST" action="/validado/notacredito/crear">
						...
						<div class="form-group">
							<label class="col-md-4 control-label">Tipo de Nota de Credito</label>
							<div class="col-md-6">
								<select class="form-control text-uppercase" id="tcompinc_id" name="tcompinc_id" onchange="getUp(this)">
